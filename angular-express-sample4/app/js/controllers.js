...
demoApp.controller('authController', ['$scope', '$window', '$location', 'authService', function ($scope, $window, $location, authService) {
	...
	$scope.login = function(credentials) { 
		...
		authService.login(credentials).then(function(data) {
			...
			console.log('percentComplete', percentComplete ); // ideal for progress bar
		});
	};
...
demoApp.controller('dashboardController', ['$scope', 'restService', function($scope, restService) {
	
	

}]);

demoApp.controller('widgetController', ['$scope', 'widgetFactory', 'restService', function($scope, widgetFactory, restService) {
